      ...
      <table className="report-table w-full border-collapse border border-black border-t-0 table-fixed">
        <thead>
          <tr className="bg-white font-bold text-center">
            ...
            <th className="border border-black border-t-0 p-2 w-1/4 align-middle">Destination Username</th>
            <th className="border border-black border-t-0 p-2 w-1/4 align-middle">Sources</th>
          </tr>
        </thead>
        <tbody>
          {data.length > 0 ? (
